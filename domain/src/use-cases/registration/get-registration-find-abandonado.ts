...
export interface GetRegistrationFindIncompleteDeps {
    registrationService: RegistrationService;
    courseService: CourseService;
    userService: UserService;
}

export async function getRegistrationFindIncomplete(deps: GetRegistrationFindIncompleteDeps) {
    const registrations = await deps.registrationService.findIncomplete();
