...
const getCourseById = async (req: Request<{ id: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const getCourseByName = async (req: Request<{ name: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const getCoursesByCategoryId = async (req: Request<{ categoryId: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const getCoursesByTeacherId = async (req: Request<{ teacherId: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const getActiveCourses = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const getUpcomingCourses = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const getFullCourses = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const updateCourse = async (req: Request<{ id: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const deleteCourse = async (req: Request<{ id: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
