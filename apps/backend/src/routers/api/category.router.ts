...
const getCategoryById = async (req: Request<{ id: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const getCategoryByName = async (req: Request<{ name: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const updateCategory = async (req: Request<{ id: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
...
const deleteCategory = async (req: Request<{ id: string }>, res: Response, next: NextFunction): Promise<void> => {
    try {
