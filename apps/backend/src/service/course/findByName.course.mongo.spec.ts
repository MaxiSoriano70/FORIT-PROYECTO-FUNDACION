...
import { findCourseByName } from "./findByName.course.mongo.js";
import { UserRole } from "../../utils/enums/userRole.js";

describe("Buscar curso por nombre con Mongo", () => {
    ...
    it("Debería devolver null si no hay coincidencias", async () => {
        const course = await findCourseByName("No existe");
    ...
    it("Debería encontrar un curso por nombre", async () => {
        ...
        const foundCourse = await findCourseByName("Curso de React Avanzado");
